...
export function studyPlan(topic: string, days = 5) {
  ...
  return `**Plano de estudos (${days} dias) — ${topic}**\n\n${steps.join("\n\n")}\n\n💡 Use a agenda do EduHub para marcar cada dia.`;
}
