    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2">
          <CardContent className="flex min-h-[20rem] flex-col p-4">
            {activeThread ? (
              <>
                <p className="mb-4 border-b pb-2 font-semibold">
                ...
                <form action={sendChatMessageAction} className="mt-4 flex gap-2 border-t pt-4">
                  <input type="hidden" name="threadId" value={activeThread.id} />
                  <Input name="body" placeholder="Digite sua mensagem..." required className="flex-1" />
