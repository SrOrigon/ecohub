...
export function LiveActivityTicker({
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-indigo-100/90 bg-gradient-to-r from-indigo-50/60 via-white to-purple-50/40 px-3.5 py-2 shadow-sm backdrop-blur-sm dark:border-indigo-950 dark:from-indigo-950/30 dark:via-slate-900/60 dark:to-purple-950/20">
