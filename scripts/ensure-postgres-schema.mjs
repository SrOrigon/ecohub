...
const STUDENT_COLUMN_PATCHES = [
  ...
  `ALTER TABLE "Student" ADD COLUMN IF NOT EXISTS "dropoutRiskScore" INTEGER NOT NULL DEFAULT 0`,
  `ALTER TABLE "Student" ADD COLUMN IF NOT EXISTS "dropoutRiskLevel" TEXT NOT NULL DEFAULT 'LOW'`,
  `ALTER TABLE "Student" ADD COLUMN IF NOT EXISTS "dropoutFactors" TEXT NOT NULL DEFAULT '[]'`,
